...
@Entity
@Table(name="ls_2004")
@NamedQuery(name="Ls2004Constituency.findAll", query="SELECT l FROM Ls2004Constituency l")
public class Ls2004Constituency implements Serializable {
