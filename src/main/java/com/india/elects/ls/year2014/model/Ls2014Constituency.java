package com.india.elects.ls.year2014.model;
...
@Entity
@Table(name="ls_2014")
@NamedQuery(name="Ls2014Constituency.findAll", query="SELECT l FROM Ls2014Constituency l")
public class Ls2014Constituency implements Serializable {
