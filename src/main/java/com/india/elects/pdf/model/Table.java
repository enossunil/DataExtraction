...
public class Table {
	...
	private TableBoundaryIndentificationHelper helper;
	...
	// Initialization and releasation
	public Table(int idx, int columnsCount, int tableId) {
		this.pageIdx = idx;
		this.columnsCount = columnsCount;
	...
	// Initialization and releasation
	public Table(int idx, int columnsCount, int tableId, TableBoundaryIndentificationHelper helper) {
		this(idx, columnsCount, tableId);
		this.helper = helper;
	}
	...
	public TableBoundaryIndentificationHelper getHelper() {
		return helper;
	}

	public void setHelper(TableBoundaryIndentificationHelper helper) {
		this.helper = helper;
	}
